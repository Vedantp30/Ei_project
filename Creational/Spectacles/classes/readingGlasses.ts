...
export class ReadingGlasses implements Spectacles {
  material: string;
  color: string;
  ...
  description(): string {
    return `Reading Glasses (Material: ${this.material}, Color: ${this.color}, Sphere: ${this.sphereRightEye}/${this.sphereLeftEye}, CYL: ${this.cylinderRightEye}/${this.cylinderLeftEye}, Axis: ${this.axisRightEye}/${this.axisLeftEye}, Temple Distance: ${this.templeDistance})`;
  }
}
